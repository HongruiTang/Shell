...
To execute fuzz tests, run

    docker run -p 80:8000 -ti --rm shell /comp0010/tools/fuzz

- Due to the nature of fuzzing, these tests take some time to run. By default, the time to run per test is 1min. This time can be adjusted in each test.
